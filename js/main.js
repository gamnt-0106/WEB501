(function ($) {
    ...
    $(".currency > a,.language > a,.top_links > a").on("click", function () {
        ...
        $(this).parents().siblings().find(".dropdown_currency,.dropdown_language,.dropdown_links")
            .removeClass("open");
    });
    ...
    $(".icone_menu > a").on("click", function () {
        ...
        $(this).parents().siblings().find(".home_menu_inner")
            .removeClass("open");
    });
    ...
    $(".shop_menu > a").on("click", function () {
        ...
        $(this).parents().siblings().find(".dropdown_shop_menu")
            .removeClass("open");
    });
    ...
    $(".footer_show_button > a").on("click", function () {
        ...
        $(this).parents().siblings().find(".footer_widgets_inner")
            .removeClass("open");
    });
    ...
    $(".portfolio_gallery").imagesLoaded(() => {
        // init Isotope
        const $grid = $(".portfolio_gallery").isotope({
    ...
    $(".canvas_close,.off_canvars_overlay").on("click", () => {
    ...
    /* ---Off Canvas Menu---*/
    const $offcanvasNav = $(".offcanvas_main_menu");
