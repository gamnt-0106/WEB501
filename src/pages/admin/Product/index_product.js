                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ${data.map((product, index) => `
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                                <a href="/#/admin/news/${product.id}/edit" class="inline-block px-4 py-3 text-black rounded bg-sky-600 ">Edit</a>
                                                                <button data-id=${product.id} class="btn btn-remove inline-block px-4 py-3 text-black rounded bg-sky-600 hover:bg-indigo-600">Delete</button>
                                                            </td>
                                                        </tr>
