                ...
                <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="">
                            ...
                            <a href="/admin/show_product" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Sản phẩm</a>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <a href="/admin/show_product" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Sản phẩm</a>
                    </div>
